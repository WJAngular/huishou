...
public class HttpKits {
	...
	private static final TrustAnyHostnameVerifier trustAnyHostnameVerifier = new HttpKits().new TrustAnyHostnameVerifier();
	
	private static SSLSocketFactory initSSLSocketFactory() {
		try {
			TrustManager[] tm = {new HttpKits().new TrustAnyTrustManager() };  
