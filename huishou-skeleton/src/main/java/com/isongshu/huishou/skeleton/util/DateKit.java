...
public class DateKit {
    ...
    public static List<String> getBettwenDate(String startDate, String endDate) {
        ...
        Date start = DateKit.parseDate(startDate);
        Date end = DateKit.parseDate(endDate);
        for (int i = 0, days = diffDate(start, end); i < days + 1; i++) {
            result.add(formatDate(DateKit.addDate(start, i)));
        }
        return result;
    }
    ...
    public static List<String> getBettwenMonth(String startDate, String endDate) {
        List<String> result = new ArrayList<String>();
        Date start = DateKit.parseDate(startDate + "-01");
        Date end = DateKit.parseDate(endDate + "-01");
        for (int i = 0, months = diffMonth(start, end); i < months + 1; i++) {
            result.add(formatMonthDate(DateKit.addMonth(start, i)));
        }
        return result;
    }
    ...
    public static Date parseDateDefaultMonthBegin(String param) {
        return "".equals(param) ? DateKit.getCurrMonthBegin() : DateKit.parseDate(param);
    }
    ...
    public static Date parseDateDefaultMonthEnd(String param) {
        return "".equals(param) ? DateKit.getCurrMonthEnd() : DateKit.parseDate(param);
    }
