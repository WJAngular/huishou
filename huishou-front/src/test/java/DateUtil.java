...
public class DateUtil {
	public static SimpleDateFormat YYYYMMDD0 = new SimpleDateFormat("yyyy-MM-dd");
	...
	public static String addDate(String date1,int date2){
		...
		return YYYYMMDD0.format(c1.getTime());
	}
	
	
	public static String addDate1(String date1,int date2){
		int res = -1;
		Calendar c1 = checkDateFormat(date1);
		c1.add(Calendar.DAY_OF_MONTH, date2);
		return YYYYMMDD2.format(c1.getTime());
	}
