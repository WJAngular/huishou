			...
			<div class="row">
				<div class="column">
					<div class="ui mini breadcrumb">
					  ...
					  <i class="right chevron icon divider"></i>
					  <div class="active section">操作员-加盟商</div>
					</div>
				</div>
			</div><!-- 头部导航 -->
									 ...
									 <div class="five fields">
								     	...
								     	<div class="field">
									        ...
									        <select class="ui dropdown" name="object.type">
												  ...
												  <option value="1" ${object.type ==  '1' ? 'selected':''}>操作员</option>
												  <option value="2" ${object.type ==  '2' ? 'selected':''}>加盟商</option>
										 	</select>
								      	</div>
						...
						<tbody>
							...
							<c:forEach items="${objectPage.getList() }" var="object">
									<tr  id="tr${object.id}"  ondblclick="openUpdateModal('${object.id}')">
										...
										<td>
											<c:forEach items="${ recycleTradeAddressCity}" var="recycleTradeAddressCity">
													<c:if test="${object.zone ==  recycleTradeAddressCity.paramCode }">
												   	 		${recycleTradeAddressCity.paramDesc }
												   	 </c:if>
											</c:forEach>	
