		...
		<div class="header">
		  ...
		  <div class=" content">
			<form class=" ui form" id="editForm" >
			 	  ...
			 	  <div class="field">
			      	  <label>品牌</label>
			        <input type="text" name="object.brand" placeholder="品牌" value="${object.brand }">
			      </div>
		        	<div class="field">
			      	  <label>型号</label>
			        <input type="text" name="object.name" placeholder="型号" value="${object.name }">
			      </div>
			 	<div class="field">
			      	  <label>联系电话</label>
			      ...
			      <div class="field">
			      	  <label>内容</label>
<%-- 			        <input type="text" name="object.remark" placeholder="联系电话" value="${object.tel }"> --%>
			        <textarea rows="5" cols="" name="object.remark">${object.remark }</textarea>
			      </div>
